...
const schema = Joi.object().keys({
    id: Joi.string()
        .guid({ version: ['uuidv4'] })
        .max(50),
    repo: Joi.string().lowercase().max(50).trim(),
    branch: Joi.string().lowercase().max(50).trim(),
    build: Joi.string().lowercase().max(50).trim(),
    state: Joi.string().lowercase().max(50).trim(),
    ...
    cypress_version: Joi.string().lowercase().max(50).trim(),
    browser_name: Joi.string().max(50).trim(),
    browser_version: Joi.string().lowercase().max(50).trim(),
    headless: Joi.boolean(),
    os_name: Joi.string().lowercase().max(50).trim(),
    os_version: Joi.string().lowercase().max(50).trim(),
    node_version: Joi.string().lowercase().max(50).trim(),
